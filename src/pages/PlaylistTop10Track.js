...
import Playlist from '../components/PlaylistTop10TrackPage/Playlist';
import { getPlaylistDetail } from '../components/api/PlaylistFuntion';
class PlaylistTop10Track extends Component {
    _isMounted = false;
    constructor() {
        super()
        this.state = {
...
export default withRouter(connect(mapStateToProps, null)(PlaylistTop10Track));
