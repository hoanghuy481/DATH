...
class Post extends Component {
    ...
    HandleDelete = (uid, id) => {
        deletePost(uid, id).then(res => {
            this.props.getRe(this.props.post.id)
        })      
    };
    componentDidMount(){
    ...
    render(){
        let {comments, numberOfitemsShown, likes,setLike,isPlay,duration,currentTime} = this.state;  
        let user = null;
        user = this.props.user !== undefined ? this.props.user : user; 
        let item ={ id: '', post: '', image: '',videos:'',like:'',id_user:'',created:'',title:'',audio:'',view:''}
        item = this.props.post !== undefined ? this.props.post : item;
                ...
                <div className="post-detail">
                    ...
                    <div className="button-like">
                        <div className="button-react">
                            {xhtmlButtonLike}
                            <a href={null} className="btn text-blue"><i className="icon ion-quote" /> comment </a>
