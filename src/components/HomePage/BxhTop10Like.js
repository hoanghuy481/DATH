...
class BxhTop10Like extends Component {
    render(){
        let post ={ id: '', post: '', image: '',videos:'',likes:'',id_user:'',created:'',title:'',audio:'',view:''}
        ...
        return (
            <div className="follow-user">
                ...
                <div>
                    ...
                    <p className="text-green">Like: {post.likes}</p>
                </div>
            </div>
        );
    }
